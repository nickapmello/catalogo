...
class MoedaBRValorPromo extends StatefulWidget {
  const MoedaBRValorPromo({
    Key? key,
    this.width,
    this.height,
...
class _PriceFieldState extends State<MoedaBRValorPromo> {
        ...
        inputFormatters: [
          ...
          TextInputFormatter.withFunction((oldValue, newValue) {
            ...
            if (text.isEmpty) {
              ...
              FFAppState().update(() {
                FFAppState().propPricePromo = price;
              });
