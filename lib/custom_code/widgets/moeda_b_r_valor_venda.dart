...
class MoedaBRValorVenda extends StatefulWidget {
  const MoedaBRValorVenda({
    Key? key,
    this.width,
    this.height,
...
class _PriceFieldState extends State<MoedaBRValorVenda> {
        ...
        inputFormatters: [
          ...
          TextInputFormatter.withFunction((oldValue, newValue) {
            ...
            if (text.isEmpty) {
              ...
              FFAppState().update(() {
                FFAppState().propPriceVenda = price;
              });
