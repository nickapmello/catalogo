                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              validator: _model
                                  .codProdutoTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content: const Text(
                                          'Seu produto foi criado corretamente!'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content: const Text(
                                          'Preencha o campo categoria corretamente, ele é obrigatório!'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                              Navigator.pop(alertDialogContext),
