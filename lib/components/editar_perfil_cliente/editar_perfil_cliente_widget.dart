...
class EditarPerfilClienteWidget extends StatefulWidget {
  const EditarPerfilClienteWidget({
    super.key,
    required this.loja,
  });
      ...
      child: Container(
        ...
        child: StreamBuilder<List<MinhaLojaRecord>>(
          ...
          builder: (context, snapshot) {
            ...
            final columnMinhaLojaRecord = columnMinhaLojaRecordList.isNotEmpty
                ? columnMinhaLojaRecordList.first
                : null;
                                  ...
                                  child: Padding(
                                    ...
                                    child: StreamBuilder<List<ClienteRecord>>(
                                      stream: queryClienteRecord(
                                        parent:
                                            columnMinhaLojaRecord?.reference,
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        final columnClienteRecord =
                                            columnClienteRecordList.isNotEmpty
                                                ? columnClienteRecordList.first
                                                : null;
                                        return Column(
                                          mainAxisSize: MainAxisSize.max,
                                          crossAxisAlignment:
                                                              ...
                                                              child:
                                                                ...
                                                                imageUrl:
                                                                    valueOrDefault<
                                                                        String>(
                                                                  currentUserPhoto,
                                                                  'https://cdn-icons-png.freepik.com/512/9203/9203764.png',
                                                                ),
                                                                width: double
                                                                    .infinity,
                                                                height: double
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: TextFormField(
                                                        controller: _model
                                                            ...
                                                            TextEditingController(
                                                          text: columnClienteRecord
                                                              ?.enderecoBairroCliente,
                                                        ),
                                                        focusNode: _model
                                                            .bairroEndClienteFocusNode,
                                                        autofocus: false,
                                                        obscureText: false,
                                                        decoration:
                                                            InputDecoration(
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: TextFormField(
                                                        controller: _model
                                                            ...
                                                            TextEditingController(
                                                          text: columnClienteRecord
                                                              ?.enderecoEstadoCliente,
                                                        ),
                                                        focusNode: _model
                                                            .estadoEndClienteFocusNode,
                                                        autofocus: false,
                                                        obscureText: false,
                                                        decoration:
                                                            InputDecoration(
