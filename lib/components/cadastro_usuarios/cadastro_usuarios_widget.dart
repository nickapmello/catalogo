...
class CadastroUsuariosWidget extends StatefulWidget {
  const CadastroUsuariosWidget({
    super.key,
    String? tipoUsuario,
  }) : this.tipoUsuario = tipoUsuario ?? 'lojista';
...
class _CadastroUsuariosWidgetState extends State<CadastroUsuariosWidget>
  ...
  void initState() {
    ...
    _model.nomeLojaCadastroTextController ??= TextEditingController();
    _model.nomeLojaCadastroFocusNode ??= FocusNode();
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Cadastre-se ${widget.tipoUsuario}',
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '86430sw0' /* Use o formulário abaixo para c... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodySmall
                                .override(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'hd53e9h7' /* Insira seu e-mail aqui... */,
                                      ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: TextFormField(
                                  controller: _model.nomeCadastroTextController,
                                  focusNode: _model.nomeCadastroFocusNode,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                            ...
                            children: [
                              if (widget.tipoUsuario == 'lojista')
                                Expanded(
                                  child: TextFormField(
                                    controller:
                                        _model.nomeLojaCadastroTextController,
                                    focusNode: _model.nomeLojaCadastroFocusNode,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .bodySmall
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        '999jdurl' /* Insira  o nome da sua loja aqu... */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'ln41fk6e' /* Insira sua senha aqui... */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller:
                                  _model.senhaCadastroConfirmarTextController,
                              focusNode: _model.senhaCadastroConfirmarFocusNode,
                              obscureText:
                                ...
                                onPressed: () async {
                                  ...
                                  await UsersRecord.collection
                                    ...
                                    ...createUsersRecordData(
                                      displayName: _model
                                          .nomeCadastroTextController.text,
                                      email: _model
                                  ...
                                  if (widget.tipoUsuario == 'lojista') {
                                    await MinhaLojaRecord.collection.doc().set({
                                      ...createMinhaLojaRecordData(
                                        nomeLoja: _model
                                            .nomeLojaCadastroTextController
                                            .text,
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          title: Text('Conta cadastrada'),
                                          content: Text(
                                              'Sua conta foi cadastrada com sucesso! Faça bom uso da nossa plataforma.'),
                                          actions: [
                                            TextButton(
