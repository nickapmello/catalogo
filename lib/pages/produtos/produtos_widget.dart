                                                                        ...
                                                                        children: [
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Builder(
                                                                                builder: (context) {
                                                                                  final imgProduto = listViewProdutoRecord.imgProduto.map((e) => e).toList().take(1).toList();
                                                                                  return Row(
                                                                                    mainAxisSize: MainAxisSize.max,
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Padding(
                                                                                  ...
                                                                                  child: AutoSizeText(
                                                                                    listViewProdutoRecord.nomeProduto.maybeHandleOverflow(
                                                                                      maxChars: 32,
                                                                                      replacement: '…',
                                                                                    ),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ToggleIcon(
                                                                            onPressed:
                                                                                () async {
                                                                              await listViewProdutoRecord.reference.update({
                                                                                ...mapToFirestore(
                                                                                  {
                                                                                    'ativo': !listViewProdutoRecord.ativo,
                                                                                  },
                                                                                ),
                                                                              });
                                                                            },
                                                                            value:
                                                                                listViewProdutoRecord.ativo,
                                                                            onIcon:
                                                                                Icon(
                                                                              Icons.verified,
                                                                              color: FlutterFlowTheme.of(context).primary,
                                                                            ...
                                                                            Builder(
                                                                              builder: (context) => Padding(
                                                                                ...
                                                                                child: InkWell(
                                                                                  ...
                                                                                  highlightColor: Colors.transparent,
                                                                                  onTap: () async {
                                                                                    FFAppState().imgProduto = listViewProdutoRecord.imgProduto.toList().cast<String>();
                                                                                      ...
                                                                                      return Dialog(
                                                                                        ...
                                                                                        child: GestureDetector(
                                                                                          ...
                                                                                          child: PopupExcluirProdutoWidget(
                                                                                            produtoExcluir: listViewProdutoRecord,
                                                                                          ),
                                                                                        ),
                                                                                      );
                                                                                    },
