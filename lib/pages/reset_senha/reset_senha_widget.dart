                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'rlg5hzsr' /* Muito bem, agora insira nos ca... */,
                              ),
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'bld3e4d1' /* Digite aqui sua nova senha */,
                                  ),
                            ...
                            child: SizedBox(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'iub1rrv2' /* Confirme aqui sua nova senha */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: (_model.senhaTextController.text !=
                                  ...
                                  ? null
                                  : () async {
                                      _model.apiResetSenha =
                                          await ResetarSenhaCall.call(
                                        oobCode: widget.oobCode,
                                        newPassword:
                                            _model.senhaTextController.text,
                                      );

                                      if ((_model.apiResetSenha?.succeeded ??
                                          true)) {
                                        ...
                                        await showDialog(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              title:
                                                  const Text('Dados não aprovados!'),
                                              content: const Text(
                                                  'Reveja se os dois campos foram corretamente preenchidos.'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
